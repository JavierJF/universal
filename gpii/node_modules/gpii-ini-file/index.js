 ...
 */
gpii.iniFile.write.sectionEnd = function (state, sectionPath, eof) {
    var output = [];

    if (eof || sectionPath.length === 0 && state.currentPathString === "") {
        // Special case where at the end of a file with no sections, where sectionBegin wouldn't have been
        // called.
        var content = gpii.iniFile.write.sectionBegin(state, ["dummy"]);
